...
- Every `references/*.md` this command names resolves the same way — first that exists of `${CLAUDE_PLUGIN_ROOT}/references/<name>`, `~/.claude/claude-health-check/references/<name>`, then the repo copy. Stated once here; the phases just name the file.
